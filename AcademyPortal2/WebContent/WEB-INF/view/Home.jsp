				...
				<div class="col-sm-6">
					 <div class="card">
					  <div class="card-body">
						...
						<spring:url value="/addFaculty" var="url2" htmlEscape="true"/>
						<a href="${url2 }" class="btn btn-primary color-b">Register</a>
						<spring:url value="/viewfaculty" var="view" htmlEscape="true" />
						<a href="${view}" class="btn btn-primary color-b">View Faculty</a> 
					  </div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="card">
					  <div class="card-body">
						...
						<spring:url value="/module" var="url3" htmlEscape="true"/>
						<a href="${url3 }" class="btn btn-primary color-b">Add</a>
				...
				<div class="col-sm-6">
					<div class="card">
					  <div class="card-body">
						...
						<a href="${url5}" class="btn btn-primary btn-sm color-b">Generate</a>

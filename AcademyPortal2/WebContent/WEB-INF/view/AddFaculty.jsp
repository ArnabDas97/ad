...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="collapse navbar-collapse" id="navbarCollapse">
		...
		<form:form class="form-inline mt-2 mt-md-0" action="logOption"
	...
	<div class="row">
		...
		<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
						...
						<hr/>
						<form:form role="form" action="facultyRegistration" commandName="addFaculty" method="post" onsubmit="showAlert()">
						<div class="card-body" style="background-color:#f5f5f5;">
					
						<div class="form-group">
							
							
							<form:input type="text" path="facultyname" name="name" id="Name" class="form-control input-lg" placeholder="Name" tabindex="1" required="required"/><br/>
							<form:select path="qualification" name="qualification" id="qualification" class="form-control input-lg" placeholder="Qualification" tabindex="3" required="required">  
        						<form:option value="Secondary" label="Secondary"/>  
       							<form:option value="Higher Secondary" label="Higher Secondary"/>  
        						<form:option value="Graduate" label="Graduate"/>  
        						<form:option value="Post Graduate" label="Post Graduate"/>  
        					</form:select></br>  
        					<form:select path="skill" name="qualification" id="qualification" class="form-control input-lg" placeholder="Qualification" tabindex="3" required="required">
        						<c:forEach items="${skillMaster}" var="sk">
        							<form:option value="${sk.skillid}">${sk.skill}</form:option>
        						</c:forEach>
        					</form:select></br>
							<font size="4">Certification </font></br></br>
							<form:input type="radio" path="certification" name="gender" value="Yes"/> Yes &nbsp;&nbsp;
							<form:input type="radio" path="certification" name="gender" value="No"/> No

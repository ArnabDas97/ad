	...
	<div class="row">
		...
		<div class="row">
				...
				<div class="card-body" style="background-color:#f5f5f5;">
					<form:form role="form" action="addadmin" commandName="addadmin" method="POST" onsubmit="showAlert()">
						<h2>Sign Up</h2>
						<hr/>
		...
		<form:input type="text" path="lastname" id="AsID" class="form-control input-lg" placeholder="Last Name" tabindex="1" required="required"/><br/>
		...
		<font size="4">Gender</font>&nbsp;&nbsp;
							...
							<form:input type="radio" path="gender" value="other"/> Others</br></br>
		...
		<form:input type="email" path="emailid" id="AsID" class="form-control input-lg" placeholder="email id" tabindex="1" required="required"/><br/>
		...
		<form:input type="text" path="adminid" id="AsID" class="form-control input-lg" placeholder="Associate ID" tabindex="1" required="required"/><br/>

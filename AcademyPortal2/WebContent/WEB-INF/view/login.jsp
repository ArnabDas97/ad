				...
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
					...
					<div class="card-body" style="background-color:#f5f5f5;">
						...
						<div class="form-group">
							<form:input type="text" path="username" class="form-control input-lg" placeholder="Associate ID" tabindex="1" name="username" /><br/>
							<form:input type="password" path="password" class="form-control input-lg" placeholder="Password" tabindex="1" name="password" /><br/>
						</div>

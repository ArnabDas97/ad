						...
						<form:form role="form" action="addBatch"
							...
							<div class="card-body" style="background-color: #f5f5f5;">
								<div class="form-group">
									...
									<br />
									<%-- <form:input type="text" path="facultyid" name="fid" id="Fid" class="form-control input-lg" placeholder="Faculty ID" tabindex="1"/><br/> --%>
									...
									<p>
										...
										<form:input type="text" id="startdate" name="nday"
											placeholder="Start Date" path="startdate"/>
										<br />
									</p>
									<p>
										End Date:&nbsp;
										<form:input type="text" id="endDate" name="eday"
											path="enddate" placeholder="End Date" />
										<br />
